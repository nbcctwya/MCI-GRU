...
num_models = 20
num_epochs = 5
save_path = '3_20240707_nasdaq_nhs16_' + str(judge_value) + '_' + str(label_t) + '_' + str(his_t) + '/'
...
# nohup /home/liyuante/miniconda3/envs/py38/bin/python /home/liyuante/neruocomputing/nasdaq100.py >> /home/liyuante/neruocomputing/log_for_all/nd100_std.txt 2>&1 &