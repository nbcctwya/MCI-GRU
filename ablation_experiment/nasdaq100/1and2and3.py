...
num_models = 20
num_epochs = 5
save_path = '20240713_nasdaq100_123' + '/'
...
for dts_one in tqdm(dts_all):
    ...
    model_train_predict_1_2_3(num_models, num_epochs, save_path, dts_one[3], kdcode_last, df3_2_dt, train_time_series_loader, train_graph_loader, X_test_time_series, test_graph_loader)

# nohup /home/liyuante/miniconda3/envs/py38/bin/python /home/liyuante/nerocomputing24/ablation_experiment/nasdaq100/1and2and3.py >> /home/liyuante/neruocomputing/log_for_all/nasdaq100123.txt 2>&1 &