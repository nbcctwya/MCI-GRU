...
filename = '/home/liyuante/nerocomputing24/dataset/zz500_2018_2023_new_2.csv'
...
for dts_one in tqdm(dts_all):
    ...
    model_train_predict_1_2_4(num_models, num_epochs, save_path, dts_one[3], kdcode_last, df3_2_dt, train_time_series_loader, train_graph_loader, X_test_time_series, test_graph_loader)

# nohup /home/liyuante/miniconda3/envs/py38/bin/python /home/liyuante/nerocomputing24/ablation_experiment/csi500/1and2and4.py >> /home/liyuante/neruocomputing/log_for_all/csi500124.txt 2>&1 &